...
from biobank_olink.cross_sectional_adj import get_data
...
def cross_sectional_adj(
    ...
    model = Model(model)
    panel = Panel(panel)
    study_name = get_study_name(exp_name="cross_sectional_adj", model=model, panel=panel,
