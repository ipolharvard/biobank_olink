...
from biobank_olink import commands
...
class ProjectCLI(click.MultiCommand):
    ...
    biobank_olink.commands package. Each module in that
    ...
    def __init__(self, *args: Any, **kwargs: Any):
        ...
        for mod_info in pkgutil.iter_modules(commands.__path__):
            name = mod_info.name
            full_name = f"biobank_olink.commands.{name}"
...
def run_cli() -> None:
    ...
    cli = ProjectCLI(help="Main entrypoint for the biobank_olink project.")
    cli()
